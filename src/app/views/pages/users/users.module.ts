...
@NgModule({
  declarations: [UsersComponent, AdduserComponent, EdituserComponent, PlayersComponent, AddplayersComponent, EditplayersComponent, OwnerMatchesComponent, PlayerMatchesComponent, SingleOwnermatchComponent, TeamsComponent],
  imports: [
	OwlDateTimeModule, 
