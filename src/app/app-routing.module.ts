...
import { LoginauthService} from '../app/services/loginauth/loginauth.service';
...
const routes: Routes = [
	...
	{path: 'demo1', loadChildren: () => import('../app/views/themes/demo1/theme.module').then(m => m.ThemeModule),canActivate: [LoginauthService] },
	/** END: themes list end */
